...
class PedidoMapperTest {
    ...
    private PedidoJpa pedidoJpaInstancia; // Renomeado para clareza
    ...
    void deveMapearPedidoDominioParaPedidoJpaCorretamente() {
        ...
        assertEquals(pedidoDominio.getId(), pedidoJpaConvertido.getId());
        ...
        assertNotNull(pedidoJpaConvertido.getCliente().getEndereco()); // ClienteMapper mapeia o endereço
        ...
        // Lembre-se: PrestadorMapper.toPrestadorJpa (original) não mapeia endereço.
        assertNull(pedidoJpaConvertido.getPrestador().getEndereco());
    }
